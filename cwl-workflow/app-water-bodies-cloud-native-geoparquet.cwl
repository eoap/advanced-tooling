...
$graph:
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: ghcr.io/eoap/mastering-app-package/crop:1.1.0
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: ghcr.io/eoap/mastering-app-package/norm_diff:1.1.0
    baseCommand: ["python", "-m", "app"]
    arguments: []
    inputs:
      rasters:
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: ghcr.io/eoap/mastering-app-package/otsu:1.1.0
    baseCommand: ["python", "-m", "app"]
    arguments: []
    inputs:
      raster:
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: docker.io/library/geop
    baseCommand: ["python", "-m", "app"]
    arguments: []
    inputs:
      item:
